 ...
 */
static char *font = "Maple Mono NF:pixelsize=30:antialias=true:autohint:true:hintstyle:hintfull";
#if FONT2_PATCH
/* Spare fonts */
static char *font2[] = {
    "LXGW WenKai Mono:pixelsize=30:antialias=true:autohint:false:hint:ture:hintstyle:hintfull",
...
static Geometry geometry = PixelGeometry; // or  CellGeometry to use the below size
...
static Shortcut shortcuts[] = {
	...
	#if ALPHA_PATCH
	{ TERMMOD,              XK_X,           changealpha,     {.f = +0.05} },
